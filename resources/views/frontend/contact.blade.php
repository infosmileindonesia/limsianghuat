...
<section>
    ...
    <div class="container mx-auto pb-16 px-2 lg:px-0">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-x-0 lg:gap-x-7 gap-y-2 lg:gap-y-0">
            <div class="bg-black rounded-2xl flex flex-col py-10 items-center justify-end gap-y-6">
                <span>
    ...
    <div class="container mx-auto pb-12 px-2 lg:px-0">
        ...
        <div class="swiper maps-swiper">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="lg:w-[1112px] lg:h-[543px] w-full h-[300px] rounded-2xl overflow-hidden">
