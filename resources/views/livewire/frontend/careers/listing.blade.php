<div>
    ...
    <div class="mt-12 mb-24 lg:mb-52">
        ...
        <div class="career-filter-card">
            <div class="items-center gap-y-4 lg:gap-y-0 grid grid-cols-3 divide-x divide-gray-300">
    ...
    <div class="px-4 lg:px-0 border-b w-full overflow-auto">
        <ul class="flex justify-around gap-4 pb-4" x-data="{ department: @entangle('selectedDepartmentLabel') }">
        ...
        <div class="space-y-4">
            @foreach ($filteredListings as $listing)
                <div class="flex justify-between items-start">
                    <div>
                        <h2 class="mb-2 font-bold text-black text-xl lg:text-2xl underline">{{ $listing->title }}</h2>
                        <p class="text-gray-500 text-base lg:text-lg">{{ $listing->description }}</p>


                        <ul class="flex flex-row gap-4 mt-4">

                            <li class="flex items-center space-x-4 px-3 lg:px-6 py-px lg:py-1 border border-gray-600 rounded-3xl text-gray-600 text-base lg:text-lgl text-center transition-all duration-300 ease-in-out">
                                <span>
