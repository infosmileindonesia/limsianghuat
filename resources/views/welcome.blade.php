                ...
                <div class="relative col-span-2 h-full">
                    <div class="lg:bottom-[-2px] lg:absolute relative lg:ml-[-19%] pt-10">
                        <div class="group relative rounded-none lg:rounded-4xl lg:w-max lg:h-max overflow-hidden cursor-pointer">
                            <img src="{{ asset('img/placeholder/Industrial.png') }}" width="593" height="493" alt="" class="mr-auto lg:max-w-[593px] group-hover:scale-110 transition-all group-hover:-translate-x-1 group-hover:translate-y-1 duration-500 ease-in-out">
                            ...
                            <div class="distribution-card">
                                ...
                                <div class="distribution-body-carousel">
                                    <div class="w-full h-full">
                                        {{-- add more swiper --}}
                                        <div data-swiper="bulkswiper" class="swiper-dis-content-{{$distribution->id}} swiper"
                                    ...
                                    <!-- Add Pagination -->
                                    <x-frontend.utils.arrow-prev className="left-arrow-swiper left-arrow-swiper-dis-content-{{$distribution->id}}" />
                                    <x-frontend.utils.arrow-next className="right-arrow-swiper right-arrow-swiper-dis-content-{{$distribution->id}}" />
                                    <div class="pagination-swiper-dis-content-{{$distribution->id}} swiper-pagination"></div>
                                </div>
                            </div>
                        </div>
                    </div>
